...
class LoadPatchVertical(Base):
    ...
    def _vertical_offset(self):
        return -self.strut_size*self.vertical_propulsor_loc/2
    ...
    def _radius_true(self):
        return self._inner_radius * math.sqrt(
            1.0- self.vertical_propulsor_loc ** 2
        )
    ...
    def patch_radius(self):
        ...
        h_to_sphere= self._inner_radius - self._inner_radius   # = 0 at equator
    ...
    @Attribute
    def _polar(self):
        loc = -self.vertical_propulsor_loc
    ...
    def _angle_bottom(self):
        ...
        horizontal_to_equator = (
            -self.vertical_propulsor_loc * self.envelope_radius
            - self._attach_height
    ...
    def _angle_top(self):
        ...
        geometric_correction2 = (math.pi / 4) * (
            -self.vertical_propulsor_loc / max(loc_90, 1e-9)
        )
    ...
    def inertia(self):
        ...
        I_lat = (1 / 12) * m * (3 * r**2 + h**2)   # Ixx = Iyy
